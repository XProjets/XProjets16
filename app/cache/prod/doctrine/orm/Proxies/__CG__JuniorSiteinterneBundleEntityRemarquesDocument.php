 ...
 */
class RemarquesDocument extends \Junior\SiteinterneBundle\Entity\RemarquesDocument implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesDocument' . "\0" . 'id', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesDocument' . "\0" . 'date', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesDocument' . "\0" . 'contenu', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesDocument' . "\0" . 'document', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesDocument' . "\0" . 'ajoutePar');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemarquesDocument $proxy) {
