 ...
 */
class RemarquesMission extends \Junior\SiteinterneBundle\Entity\RemarquesMission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesMission' . "\0" . 'id', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesMission' . "\0" . 'date', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesMission' . "\0" . 'contenu', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesMission' . "\0" . 'mission', '' . "\0" . 'Junior\\SiteinterneBundle\\Entity\\RemarquesMission' . "\0" . 'ajoutePar');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemarquesMission $proxy) {
