...
/* JuniorSiteinterneBundle:Siteinterne:categories.html.twig */
class __TwigTemplate_3062136f9eb856a214380fbcb55d50caff07697a2d76b75fbe94ac774bc7a0b3 extends Twig_Template
{
...
\t\t\t\t\t";
        // line 18
        if ((isset($context["listeCategories"]) ? $context["listeCategories"] : null)) {
            // line 19
            echo "\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cat"]) {
                ...
                echo " <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("junior_siteinterne_missions_categories", array("id" => $this->getAttribute($context["cat"], "id", array()), "suppr" => "supprimer")), "html", null, true);
...
\t\t\t\t\t\t\t";
        // line 36
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "name", array()), 'label', array("label_attr" => array("class" => "col-sm-4 col-sm-offset-1 control-label"), "label" => "Nom de la catégorie"));
        echo "
...
";
    ...
    {
        return "JuniorSiteinterneBundle:Siteinterne:categories.html.twig";
    }
